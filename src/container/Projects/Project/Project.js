    ...
    return (
        <>
            <div className={projectClasses}>
                ...
                {/* PROJECT IMAGE */}
                <VisibilitySensor partialVisibility offset={{bottom:400}} onChange={onChange}>
                    <div className={classes.ImageContainer}>
                        <img
                            style={
                                props.projectData.name === 'MyAppartment'
                                    ? {
                                          height: '400px',
                                          width: 'auto',
                        ...
                        <svg
                            className={`${classes.Bulb} ${
                                projectTitleColored && classes.WhiteBulb
                            }`}
                            id="visual"
                            viewBox="0 0 500 500"
                            width="500"
                ...
                <div className={`${classes.Item} ${classes.LiveDemoItem}`}>
                    <div className={classes.BtnContainer}>
                        ...
                        <CvButton
                            type={'github'}
                            url={props.projectData.github}
                            colored={projectTitleColored}
                        />
                        ...
                        {props.projectData.liveDemo ? (
                            <LiveIcon
                                url={props.projectData.liveDemo}
                                colored={projectTitleColored}
                            />
                        ) : null}
                    </div>
